...
import { transaction, ui } from 'redux/actions';
...
const ComboDealProductCard = ({ classes, item, index }) => {
  ...
  return (
    <div className={classes.comboDealProductCard}>
      {/* Product Info Card */}
      <ProductInfo item={item} index={index} discountDetails={discountDetails} isAdded={isAdded} />
...
export default withStyles(styles)(ComboDealProductCard);
